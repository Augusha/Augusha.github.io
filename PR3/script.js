...
document.write(`<br><span>Результат об'єднання: ${first.concat(second).toString()}</span>`);
...
alpha.push(1, 2, 3);
document.write(`<br><span>Результат додавання 1,2,3: ${alpha.toString()}</span>`);
...
let arr4 = ["js", "css", "jq"];
document.write(`Останній елемент масиву ${arr4.toString()} : ${arr4[arr4.length - 1]}`);

// Task 5
document.write("<h2>Завдання 5</h2>");
let arr5 = [1, 2, 3, 4, 5];
let newArr5 = arr5.splice(3, 2);
document.write(`<span>Початковий масив [1, 2, 3, 4, 5] <br>Новий масив : ${newArr5.toString()}</span>`);

// Task 6
document.write("<h2>Завдання 6</h2>");
let arrSix = [1, 2, 3, 4, 5];
arrSix.splice(1, 2);
document.write(`<span>Початковий масив [1, 2, 3, 4, 5] <br>Новий масив : ${arrSix.toString()}</span>`);

// Task 7
document.write("<h2>Завдання 7</h2>");
let arr7 = [1, 2, 3, 4, 5];
let newArr7 = arr7.splice(1, 3);
document.write(`<span>Початковий масив [1, 2, 3, 4, 5] <br>Новий масив : ${newArr7.toString()}</span>`);

// Task 8
document.write("<h2>Завдання 8</h2>");
let arr8 = [1, 2, 3, 4, 5];
arr8.splice(3, 0, "a", "b", "c");
document.write(`<span>Початковий масив [1, 2, 3, 4, 5] <br>Новий масив : ${arr8.toString()}</span>`);
...
arr9.splice(6, 0, "c");
arr9.splice(8, 0, "e");
document.write(`<span>Початковий масив [1, 2, 3, 4, 5] <br>Новий масив : ${arr9.toString()}</span>`);
...
document.write(`<span>Початковий масив [3, 4, 1, 2, 7] <br>Новий масив : ${arr10.toString()}</span>`);
...
document.write(` Дано рядок 'я вчу javascript!', записано в масив кожен символ  ${arr14.toString()}`);
...
document.write("Заповнили масив індекс елемента= к-сть символів x:<br>Результат на основі масиву з 6-ми елементів " + arr15.toString());
...
// Task 18
document.write(`<h2>Завдання 18</h2>Масив з елементами "Jazz","Blues" `);
...
document.write(`Функція, яка перетворює рядки типу “my-short-string” в  “myShortString”<br>Результат на основі прикладу -webkit-transition  ${camelize(str19)}`);
...
document.write("Пошук в масиві [8, 2, 3, 4, 5, 9, 8, 42, 21, 14] елементів >=4 і  <=9 :  ");
...
document.write(`Початковий масив ${arr21.toString()}`);
